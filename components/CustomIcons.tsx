...
export const CustomIcons: Record<string, React.FC<React.SVGProps<SVGSVGElement>>> = {
  // --- APPAREL ---
  Dress: (props) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" {...ICON_OPTS} {...props}>
