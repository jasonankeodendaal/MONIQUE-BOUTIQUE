    ...
    <main className="pt-0">
      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-6 md:mb-12"><span className="text-[9px] font-black uppercase tracking-[0.5em] text-slate-300">{settings.homeCategorySectionTitle}</span></div>
              ...
              {[
                ...
                return (
                  <div key={i} className={`flex flex-col items-center text-center ${i === 2 ? 'col-span-2 md:col-span-1' : ''}`}>
                    <div className="mb-4 md:mb-8 p-4 md:p-6 bg-white rounded-3xl shadow-xl border border-slate-50 text-primary group hover:scale-110 transition-transform duration-500"><IconComponent size={20} className="md:w-8 md:h-8" strokeWidth={1.5} /></div>
